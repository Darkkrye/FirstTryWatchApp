...
class SkiResortDataSource: NSObject {
    ...
    override internal init() {
        self.allObjects = [
            ...
            SkiResort(name: "Vanoise Express", photoURL: NSURL(string: "http://trinum.com/ibox/ftpcam/Peisey-Vallandry_vanoise-expresse.jpg")!, temperature: 15),
            SkiResort(name: "Arc 1950 Village", photoURL: NSURL(string: "https://noahcatalog1.blob.core.windows.net/img/15ead594-3847-441c-9aa7-802af71d94d1.jpg")!, temperature: -10)
        ]
    }
