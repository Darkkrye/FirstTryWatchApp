...
class SkiResortDataSource: NSObject {
    ...
    override internal init() {
        self.allObjects = [
            ...
            SkiResort(name: "Arc 1950 Village", photoURL: NSURL(string: "https://noahcatalog1.blob.core.windows.net/img/15ead594-3847-441c-9aa7-802af71d94d1.jpg")!, temperature: 0)
        ]
    }
